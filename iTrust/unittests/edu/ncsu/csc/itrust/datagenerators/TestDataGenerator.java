...
public class TestDataGenerator {
	...
	public void patient27() throws FileNotFoundException, IOException, SQLException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient27.sql");
	}
	
	public void patient28() throws FileNotFoundException, IOException, SQLException {
		new DBBuilder(factory).executeSQLFile(DIR + "/patient28.sql");
	}
	
	public void patient29() throws FileNotFoundException, IOException, SQLException {
	...
	*/
	...
	public void standardData() throws FileNotFoundException, IOException, SQLException {
		...
		appointmentType();
		appointment();
		foodDiary();  //New SQL for FoodDiary
...
//		System.out.println("Operation completed.");
	...
	/**
	 * Creates the food diary SQL table.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void foodDiary() throws FileNotFoundException, SQLException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fooddiary.sql");
	}
