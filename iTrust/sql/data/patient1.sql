...
VALUES (1,'2007-06-11','Breakfast','Apple',1,2,3,4,5,6,7,8)
 ON DUPLICATE KEY UPDATE entry_id = entry_id;
 
INSERT INTO fooddiary(patient_id,entry_date,meal_type,food_name,servings,calories,fat,sodium,carbs,sugar,fiber,protein)
VALUES (1,'2007-06-11','Lunch','Sandwich',1,4,5,6,7,8,9,10)
 ON DUPLICATE KEY UPDATE entry_id = entry_id;
 
 INSERT INTO fooddiary(patient_id,entry_date,meal_type,food_name,servings,calories,fat,sodium,carbs,sugar,fiber,protein)
VALUES (1,'2007-06-11','Dinner','Macaroni',1,10,11,10,7,8,6,10)
 ON DUPLICATE KEY UPDATE entry_id = entry_id;
 
 INSERT INTO fooddiary(patient_id,entry_date,meal_type,food_name,servings,calories,fat,sodium,carbs,sugar,fiber,protein)
VALUES (1,'2007-06-12','Breakfast','Orange',1,4,3,6,5,8,9,10)
 ON DUPLICATE KEY UPDATE entry_id = entry_id;
 
INSERT INTO fooddiary(patient_id,entry_date,meal_type,food_name,servings,calories,fat,sodium,carbs,sugar,fiber,protein)
VALUES (1,'2007-06-12','Lunch','Tuna',1,4,8,6,2,13,9,14)
 ON DUPLICATE KEY UPDATE entry_id = entry_id;
