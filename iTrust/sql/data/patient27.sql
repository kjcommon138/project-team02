...
INSERT INTO users(MID, password, role, sQuestion, sAnswer) 
			VALUES (27, '30c952fab122c3f9759f02a6d95c3758b246b4fee239957b2d4fee46e26170c4', 'patient', 'what is your favorite color?', 'blue')
 ON DUPLICATE KEY UPDATE MID = MID;
 /*password: pw*/

DELETE FROM personalhealthinformation WHERE PatientID = 27;
...
VALUES ( 27,  11, 72,   180,   0, 9,      100,          100,           40,             100,         100,          9000000000, '2007-06-07 20:33:58','2007-06-07',24.41)
on duplicate key update OfficeVisitID = OfficeVisitID;

INSERT INTO personalhealthinformation
(PatientID,OfficeVisitID,Height,Weight,Smoker,SmokingStatus,BloodPressureN,BloodPressureD,CholesterolHDL,CholesterolLDL,CholesterolTri,HCPID,AsOfDate,OfficeVisitDate,BMI)
VALUES ( 27,  23, 72,   185,   0, 9,      107,          104,           41,             104,         101,          9000000000, '2007-06-11 14:38:12','2007-06-11',25.1)
on duplicate key update OfficeVisitID = OfficeVisitID;

INSERT INTO officevisits(id,visitDate,HCPID,notes,HospitalID,PatientID)
VALUES (11,'2005-10-10',9000000000,'Yet another office visit.','9',27)
 ON DUPLICATE KEY UPDATE id = id;
 
 INSERT INTO officevisits(id,visitDate,HCPID,notes,HospitalID,PatientID)
VALUES (23,'2007-06-11',9000000000,'Yet another office visit.','1',27)
 ON DUPLICATE KEY UPDATE id = id;
 
INSERT INTO fooddiary(patient_id,entry_date,meal_type,food_name,servings,calories,fat,sodium,carbs,sugar,fiber,protein)
VALUES (27,'2014-03-16','Lunch','Chocolate Shake',2,500,23.5,259,66.5,42.4,0,5.9)
