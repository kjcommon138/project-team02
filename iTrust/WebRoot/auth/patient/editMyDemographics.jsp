...
<table cellspacing=0 align=center cellpadding=0 class="fTable">
	<br />
	<tr>
	<th colspan="3" id="link_<%=StringEscapeUtils.escapeHtml("")%>">
	...
	<tr>
		<td>
			<div id="table_<%=StringEscapeUtils.escapeHtml("")%>">
				<form action="editMyDemographics.jsp" method="post"
					id="edit_<%=StringEscapeUtils.escapeHtml("")%>">
					...
					<table>
									...
									<table class="fTable" align=center style="width: 350px;">
										<tr>
											<th colspan=2>Patient Information <input type="hidden"
												...
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getMID()))%>">
											</th>
										</tr>
										<tr>
											<td class="subHeaderVertical">First Name:</td>
											<td><input name="firstName"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getFirstName()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Last Name:</td>
											<td><input name="lastName"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getLastName()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Email:</td>
											<td><input name="email"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getEmail()))%>"
												type="text"></td>
										</tr>
										<tr>
						...
						+ (parent.getStreetAddress1()))%>"
												type="text"><br /> <input name="streetAddress2"
												value="<%=StringEscapeUtils.escapeHtml(""
						+ (parent.getStreetAddress2()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">City:</td>
											<td><input name="city"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getCity()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">State:</td>
											<td><itrust:state name="state"
													value="<%=StringEscapeUtils.escapeHtml(parent.getState())%>" /></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Zip:</td>
											<td><input name="zip"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getZip()))%>"
												maxlength="10" type="text" size="10"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Phone:</td>
											<td><input name="phone"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getPhone()))%>"
										...
										<tr>
											...
											<td><input name="MotherMID"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getMotherMID()))%>"
										...
										<tr>
											...
											<td><input name="FatherMID"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getFatherMID()))%>"
												maxlength="10" type="text"></td>
										</tr>
										<tr>
											...
											<td><select name="creditCardType">
													...
													<option value="MASTERCARD"
														<%=StringEscapeUtils
						.escapeHtml(""
								+ (parent.getCreditCardType().equals("MASTERCARD") ? "selected"
										: ""))%>>Mastercard</option>
													<option value="VISA"
														<%=StringEscapeUtils.escapeHtml(""
						+ (parent.getCreditCardType().equals("VISA") ? "selected"
								: ""))%>>Visa</option>
													<option value="DISCOVER"
														<%=StringEscapeUtils
						.escapeHtml(""
								+ (parent.getCreditCardType().equals("DISCOVER") ? "selected"
										: ""))%>>Discover</option>
													<option value="AMEX"
														<%=StringEscapeUtils.escapeHtml(""
						+ (parent.getCreditCardType().equals("AMEX") ? "selected"
								: ""))%>>American
														Express</option>
											</select></td>
										</tr>
									...
									<table class="fTable" align=center style="width: 350px;">
										...
										<tr>
											...
											<td><input name="icName"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcName()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Address:</td>
											<td><input name="icAddress1"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcAddress1()))%>"
												type="text"><br /> <input name="icAddress2"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcAddress2()))%>"
												type="text"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">City:</td>
											<td><input name="icCity"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcCity()))%>"
												type="text"></td>
										</tr>
										...
										<tr>
											...
											<td><itrust:state name="icState"
													value="<%=StringEscapeUtils.escapeHtml(parent.getIcState())%>" />
											</td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Zip:</td>
											<td><input name="icZip"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcZip()))%>"
												maxlength="10" type="text" size="10"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Phone:</td>
											<td><input name="icPhone"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcPhone()))%>"
												type="text" size="12" maxlength="12"></td>
										</tr>
										<tr>
											<td class="subHeaderVertical">Insurance ID:</td>
											<td><input name="icID"
												value="<%=StringEscapeUtils.escapeHtml("" + (parent.getIcID()))%>"
												type="text"></td>
										</tr>
									</table> <br>
									</div>
